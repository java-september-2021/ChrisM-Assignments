		...
		<div class="row">
			<div class="col-4 offset-1">
				...
				<form:form action="/registration" method="POST" modelAttribute="user">
					...
					<!-- TODO: Change this to email input after testing! -->
					<form:input path="email" class="form-control" type="text"/>
					
					<form:label path="password" class="form-label">Password :</form:label>
					<form:errors path="password"/>
					<!-- TODO: Change this to password input after testing! -->
			...
			<div class="col-4 offset-2">
				...
				<form action="/login" method="POST">
					...
					<input type="text" id="loginPassword" class="form-control" name="loginPassword"/>
